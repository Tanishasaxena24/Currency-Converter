...
const countries=[{code:"USD",name:"United States Dollar"},{code:"INR",name:"Indian Rupee"
...
countries.forEach(country=>{
    ...
    // setting default values of currency
...
try {
    ...
    converterContainer.innerHTML=`<h2>Error while fetching exchange rates!!`
}
